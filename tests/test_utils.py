...
class RRIFileOpeningTestCase(unittest.TestCase):
    ...
    def test_open_rri_text_file_with_mistake(self):
        rri_file_name = 'tests/test_files/test_file_mistake_1.txt'
        self.assertRaises(ValueError, open_rri, rri_file_name)
